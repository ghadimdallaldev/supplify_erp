...
- **Custom needs** — Enterprise plans can be defined with custom limits and features and assigned only by admin (e.g. manual onboarding, SLAs, custom contracts). See **docs/ENTERPRISE.md** for what enterprise gets and how it’s positioned.
