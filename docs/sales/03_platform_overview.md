...
- **Subscriptions** — Each tenant has a tenant-specific plan (30-day Free Trial, Growth, or Scale) with limits and features; admins can change plans, add-ons, and override limits. See [four-plan-pricing-model.md](../product/four-plan-pricing-model.md).
