...
2. Optional: driver sends GPS pings during active assignment; restaurant may see **sanitized** live tracking on order detail (`RestaurantOrderTrackingPanel`) — see [fulfillment-logistics.md](./fulfillment-logistics.md). GPS does **not** auto-complete receiving.
...
- GPS / tracking spec: [fulfillment-logistics.md](./fulfillment-logistics.md)
- Manual QA: `GPS-*` and `RECV-*` rows in [MANUAL_TEST_CHECKLIST.md](../qa/MANUAL_TEST_CHECKLIST.md)
