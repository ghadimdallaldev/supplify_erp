...
| Lifecycle isolation                | Deactivate / reactivate / unlink / PATCH require the restaurant to belong to the caller's org                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Legacy Location `branchId`         | Report / reorder / forecast / recipe / quick-list / expiry / consumer-menu / consumer-order list / fulfillment-options / restaurant order-calendar query and body params reject foreign IDs. Quick-list create and consumer menu category/item/import writes reject a foreign `branchId` with 400. Order calendar, order detail, invoice CSV, onboarding team, onboarding profile `branch_count`, invoices, delivery board/ETA/routes/driver detail, and consumer receipts join `branch` names only when `tenant_id` matches the restaurant. Delivery-board SQL omits the branch join unless `branch.tenant_id` exists. |
| Grant / revoke branch access       | Org Owner only; restaurant must belong to the caller organization                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Consolidated reporting             | `GET /api/restaurant-org/reports/overview`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Central purchasing                 | Explicitly out of scope; all `/api/restaurant-org/central-purchasing/*` endpoints return `410 GONE`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
