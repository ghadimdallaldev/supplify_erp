...
| Smart reorder forecasts (AI P1) | [ai-smart-reorder.md](./ai-smart-reorder.md)                                                                                                                                                                             |
...
| Topic                     | Document                                                                                                                                             |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Registration & activation | [tenant-registration.md](./tenant-registration.md) · Legal re-accept: [../ui/LEGAL_PACK_REACCEPTANCE.md](../ui/LEGAL_PACK_REACCEPTANCE.md)           |
