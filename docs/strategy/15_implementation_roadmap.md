...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| Product      | 180 migrations, 554 API routes, 225+ backend / 100+ frontend tests; full RBAC, tier enforcement, GPS logistics, chat, reservations (Part 1 §1.2) | GTM can lead with depth, not a prototype narrative                   |
...
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **Product**      | Live payment gateway (Stripe and/or Lebanon/MENA-capable processor — Part 11 §11.1 **M** effort); automate branch/warehouse add-on billing (**S–M**, Part 7 §7.7); begin Platinum catalog-only gap closure (API/webhooks largest item — Part 11 §11.6)      | Gateway is Part 1 §1.6 0–6 month objective; without it, self-serve checkout remains handicapped even if manual path works |
...
| Workstream       | Milestones                                                                                                                                                                                                                      | Gate / dependency                                                 |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| **Product**      | Continue catalog-only Platinum closure (Part 1 §1.6 6–12 month objective); WhatsApp Business API go-live (**S–M**, Part 11 §11.3); resolve Free Trial / Gold parity positioning (product + engineering decision, Part 11 §11.1) | Do not market AI quick lists until backend-enforced (Part 9 §9.6) |
...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| **Product**      | Payment gateway stable; catalog-only gap substantially closed; `AI_ENABLED` operational toggle verified before any AI marketing (Part 11 §11.2)     | Feature-catalog integrity target (Part 1 §1.15)                        |
...
| ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| **Product**      | Multi-currency conversion service (Part 11 §11.1 Next); data-residency planning + regional deployment pilot; enterprise security hardening (Part 11 §11.4); WhatsApp live in production workflows                                                                          | GCC readiness work begins **before** GCC sales (Part 11 sequencing)                       |
...
Month 4–12: [Platinum catalog-only closure] ──blocks──▶ [Platinum/Enterprise sales]
                    │
                    └──protects──▶ [Trust / churn risk, Part 13 §13.1]
...
| **M4–6**   | WhatsApp API; Platinum gap work         | ≥3 anchor suppliers; 15–20 conversations                   | Bilingual landing page; M6 review         | Billing automation (eng)                             | —                       | ~33 / ~$3,630 (M6)                |
| **M7–12**  | Platinum enforcement; rate limiting     | PQL follow-up; Gold modal mix                              | Events; SEO; Year 1 close                 | Monitor support threshold; assess commercial trigger | Lebanon gate assessment | ~58 / ~$6,380 (M12)               |
