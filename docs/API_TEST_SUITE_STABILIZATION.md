...
**Workflow:** Use **`pnpm test:api`** (non-watch) from the repo root for CI, PR checks, and Cursor verification. See **[QA automation guide](./qa/QA_AUTOMATION_GUIDE.md)** for all scripts, test rules, and CI.
