...
| `/api/orders`                  | `orders.routes.js`                    | Orders lifecycle, manual orders, amendments nested under `/:orderId/amendments` |
| `/api/approvals`               | `approvals.routes.js`                 | Order approval rules and requests                                               |
| `/api/promotions`              | `promotions.routes.js`                | Supplier promotions; restaurant active deals                                    |
...
| `/api/public`                  | `public.routes.js`                    | Public reservations, staff portal, restaurant discovery (rate-limited)          |
| `/api/public/invitations`      | `branch-invitations-public.routes.js` | Accept branch invitation (token-based)                                          |
| `/api/admin-dashboard`         | `admin-dashboard.routes.js`           | Admin console: plans, tenants, feature flags, impersonation                     |
