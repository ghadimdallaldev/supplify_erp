...
| Bulk image import (API)    | `IMPORT_ZIP_MAX_BYTES`, `IMPORT_IMAGE_MAX_BYTES` (defaults OK) | same                                              | same                                           |

Full tables: [environment-variables.md](./environment-variables.md). Bulk image import: [../features/bulk-product-image-import.md](../features/bulk-product-image-import.md). Tracking spec: [../features/drivers-and-gps-tracking.md](../features/drivers-and-gps-tracking.md). Email system: [../features/email-system.md](../features/email-system.md). Deploy guide: [railway-environments.md](./railway-environments.md).
