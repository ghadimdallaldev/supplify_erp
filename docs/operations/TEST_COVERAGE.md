...
Automated coverage spans API routes, services, libraries, middlewares, jobs, and React units. Manual regression: [MANUAL_TEST_CHECKLIST.md](../qa/MANUAL_TEST_CHECKLIST.md). Feature-level test maps: [promotions-deals.md](../features/promotions-deals.md), [waitlist-auto-promotion.md](../features/waitlist-auto-promotion.md).
...
- [QA automation guide](../qa/QA_AUTOMATION_GUIDE.md)
- [API test suite stabilization](../API_TEST_SUITE_STABILIZATION.md)
- [MANUAL_TEST_CHECKLIST.md](../qa/MANUAL_TEST_CHECKLIST.md)
