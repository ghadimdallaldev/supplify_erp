...
| Subscription billing                  | 1 h                                             | [`subscription-billing.job.js`](../../apps/api/src/jobs/subscription-billing.job.js) — renew, `notifyBillingRenewed` / `notifyBillingPaymentFailed` / `notifyBillingAccountLocked`                                               |
...
| Free sandbox expiry                   | 1 h                                             | [`free-sandbox-expiry.job.js`](../../apps/api/src/jobs/free-sandbox-expiry.job.js) — locks expired Free Trial; `notifyBillingTrialExpired` + `notifyBillingAccountLocked`                                                        |
