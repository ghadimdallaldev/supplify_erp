...
See also: `docs/architecture/rbac-permission-matrix.md`
...
- `docs/archive/audits/rbac-roles-permissions-audit.md` — Driver hardening & prior fixes
- `docs/features/tenant-roles.md` — Feature overview
- `docs/architecture/rbac-overview.md`, `RBAC_PERMISSION_MATRIX.md`
