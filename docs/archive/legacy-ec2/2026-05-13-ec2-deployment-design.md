...
> **Archived — legacy only.** Supplify production hosting uses **Railway** ([railway-environments.md](../../operations/railway-environments.md)). This spec is not the current deploy path.
