...
- **Products / warehouses:** Plan limits apply (e.g. Free: 10 SKUs, 0 warehouses; Silver: 250 SKUs, 1 warehouse, up to 3 active promotions). See [SUBSCRIPTIONS.md](../product/subscriptions.md).
...
See [drivers-and-gps-tracking.md](../features/drivers-and-gps-tracking.md).
