...
Presenter path: [../archive/old/demo-script.md](./../archive/old/demo-script.md) (includes restaurant + supplier GPS demo steps)  
Full checklist: [regression-checklist.md](./regression-checklist.md) — delivery GPS: **§6.6.1**, **§7.4.1**, **§7.4.2**
...
- [ ] [../archive/old/demo-script.md](./../archive/old/demo-script.md) executed once — all steps Pass
