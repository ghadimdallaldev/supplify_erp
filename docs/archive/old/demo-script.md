...
Full regression: [regression-checklist.md](./regression-checklist.md) (delivery GPS: **§6.6.1**, **§7.4.1**, **DRV-GPS\***)  
Billing detail: [../archive/old/manual-test-checklist-billing-activation.md](./../archive/old/manual-test-checklist-billing-activation.md)  
Feature spec: [drivers-and-gps-tracking.md](../features/drivers-and-gps-tracking.md)
