...
export default function RestaurantChatPage() {
  ...
  const loadThreads = () => {
    try {
      const userThreads = chatService.getThreadsForUser(user?.id || '', (user?.role || 'restaurant') as 'restaurant' | 'supplier');
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Communicate with your suppliers</p>
        </div>
                ...
                <div className="max-h-[calc(100vh-300px)] overflow-y-auto">
                  {threads.length === 0 ? (
                    <div className="p-4 text-center text-gray-500">
                      ...
                      <p>No supplier conversations yet</p>
              ...
              {selectedThread ? (
                ...
                <CardContent className="flex-1 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p>Choose a supplier from the list to start chatting</p>
                  </div>
                </CardContent>
              )}
            </Card>
