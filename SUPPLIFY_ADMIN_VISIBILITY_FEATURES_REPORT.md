...
- [`docs/features/admin-operations-visibility.md`](docs/features/admin-operations-visibility.md)
- [`docs/blueprint/admin/admin_endpoints.md`](docs/blueprint/admin/admin_endpoints.md) updated
- [`docs/admin/ADMIN_PANEL_TABS_AUDIT.md`](docs/admin/ADMIN_PANEL_TABS_AUDIT.md) updated
