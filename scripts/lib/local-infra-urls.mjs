...
export function buildNativeInfraEnv(dockerVars = readDockerEnv()) {
  ...
  return {
    ...
    S3_BUCKET: dockerVars.S3_BUCKET || 'supplify',
    S3_BUCKETS: dockerVars.S3_BUCKETS || '',
    S3_PUBLIC_READ: 'true',
    S3_ACCESS_KEY: dockerVars.MINIO_ROOT_USER || 'minioadmin',
    S3_SECRET_KEY: dockerVars.MINIO_ROOT_PASSWORD || 'minioadmin',
