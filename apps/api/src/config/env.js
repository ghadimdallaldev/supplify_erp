...
export const config = {
  ...
  // Past this GPS fix age an ETA is withheld rather than quoted from a stale position.
  DELIVERY_ETA_MAX_LOCATION_AGE_SECONDS: envInt(
    process.env.DELIVERY_ETA_MAX_LOCATION_AGE_SECONDS,
    900
  ),
