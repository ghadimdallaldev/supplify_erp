  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        blocksByFeature,
        blocksByLimit,
        countsPerEventType: { '7d': countsPerEventType7d, [`${days}d`]: countsPerEventType30d },
        funnelDropOff: { '7d': funnelDropOff7d, [`${days}d`]: funnelDropOff30d },
        recommendationFunnel: {
          '7d': recommendationFunnel7d,
          [`${days}d`]: recommendationFunnel30d,
        },
      },
      error: null,
      requestId: req.requestId,
