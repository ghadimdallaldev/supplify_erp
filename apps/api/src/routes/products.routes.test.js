...
describe('Products Routes', () => {
  ...
  describe('GET /api/products/categories', () => {
    it('should return product categories', async () => {
      db.query.mockResolvedValueOnce({
        rows: [
          { id: 'cat-1', name: 'Beverages', slug: 'beverages', description: 'Drinks', display_order: 1 },
  ...
  describe('POST /api/products', () => {
    it('should create a new product', async () => {
      ...
      vi.mocked(checkLimit).mockResolvedValueOnce({ allowed: true, current: 0, limit: 100, isOverLimit: false, isUnlimited: false });
