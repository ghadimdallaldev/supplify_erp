...
<body style="margin:0;padding:0;background:#f1f5f9;font-family:system-ui,-apple-system,sans-serif;line-height:1.6;color:#0f172a;direction:${dir};text-align:${textAlign};">
  <div style="max-width:560px;margin:32px auto;padding:0 16px;">
    <div style="background:#fff;border-radius:12px;padding:32px;box-shadow:0 1px 3px rgba(15,23,42,0.08);">
      <p style="margin:0 0 8px;font-size:13px;font-weight:700;letter-spacing:0.05em;text-transform:uppercase;color:#64748b;">${escapeHtml(brand)}</p>
      <h1 style="margin:0 0 20px;font-size:22px;font-weight:700;color:#0f172a;">${escapeHtml(resolvedTitle)}</h1>
      ${greeting}
