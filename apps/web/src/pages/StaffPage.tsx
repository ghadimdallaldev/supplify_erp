...
export function StaffPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'team' | 'schedule' | 'pto' | 'announcements' | 'documents' | 'reports'
  >('team')
                ...
                <CardContent>
                  {staffLoadError ? (
                    ...
                    <div className="rounded-lg border border-dashed border-[var(--app-border-mid)] bg-[var(--brand-ultra)] p-6 text-center text-sm text-[var(--text-muted)]">
                      <p>
                        No staff yet. Add your first teammate to start scheduling and clocking time.
                      </p>
                    </div>
                  ) : (
                    <div className="space-y-3">
                              ...
                              <div className="flex items-center gap-2">
                                {isOnShift ? (
                                  <Button
                                    ...
                                    variant="outline"
                                    onClick={() =>
                                      openEntry && handleCheckOut(member, openEntry.id)
                                    }
          ...
          <TabsContent value="schedule" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Approve coverage changes to keep the board accurate.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                {swapsLoading ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Let a team member request coverage for their shift.
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="pto" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Approve vacation, sick days, or unpaid leave with policy context.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {ptoLoading ? (
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Recurring preferences keep schedule conflicts minimal.
                </CardDescription>
              </CardHeader>
                ...
                <div className="space-y-3">
                  <div className="rounded-lg border border-[var(--app-border)] bg-white p-4 shadow-sm">
                    ...
                    <div className="mt-3 space-y-2 text-sm">
                      ...
                      <div className="flex justify-end">
                        <Button
                          onClick={handleCreatePerformanceNote}
          ...
          <TabsContent value="reports" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Review approved hours and generate payroll-ready exports.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="grid gap-3 sm:grid-cols-3">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        setPayrollForm((prev) => ({ ...prev, regularHours: event.target.value }))
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        setPayrollForm((prev) => ({ ...prev, overtimeHours: event.target.value }))
                      }
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(event) =>
                        setPayrollForm((prev) => ({ ...prev, breakMinutes: event.target.value }))
                      }
                    />
                  </div>
                </div>
                      ...
                      <tbody className="divide-y divide-[var(--app-border)]">
                        {payrollExports.map((exportRow) => (
                          <tr key={exportRow.id}>
                            ...
                            <td className="px-4 py-3">
                              <Badge className="bg-[var(--brand-ultra)] text-[var(--text-muted)]">
                                {exportRow.status.toLowerCase()}
                              </Badge>
                            </td>
                            <td className="px-4 py-3 text-[var(--text-mid)]">
                              {exportRow.totals
