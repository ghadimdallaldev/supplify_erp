    ...
    <Card data-testid="order-pod-panel">
      ...
      <CardContent className="space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          {photoUrl ? (
            <div>
              <p className="mb-2 text-sm font-medium text-[var(--text-muted)]">Delivery photo</p>
          ...
          {signatureUrl ? (
            <div>
              <p className="mb-2 text-sm font-medium text-[var(--text-muted)]">Signature</p>
        ...
        {proof.delivery_timestamp && (
          <p className="text-xs text-[var(--text-muted)]">
            Recorded {new Date(proof.delivery_timestamp).toLocaleString()}
          </p>
        )}
      </CardContent>
    </Card>
