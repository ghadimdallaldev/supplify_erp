...
export default defineConfig({
  ...
  // Hosted app-dev is flaky (DNS/timeouts); retry once outside CI as well when targeting HTTPS.
  retries: process.env.CI ? 2 : baseURL.startsWith('https://') ? 1 : 0,
  workers: process.env.CI ? 2 : baseURL.startsWith('https://') ? 2 : undefined,
