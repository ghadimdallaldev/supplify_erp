...
**Railway (recommended):** committed defaults in [`deploy/railway/`](../railway/README.md) (auto-loaded on deploy). Secrets: `deploy/railway/development/secrets.env.example`. Local templates: `apps/api/.env.{dev,preprod,prod}.example` — see [railway-environments.md](../../docs/operations/railway-environments.md).
